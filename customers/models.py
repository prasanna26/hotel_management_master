...
class hotel_deposit(models.Model):
...
class Customer(models.Model):
    ...
    hotel_fee_paid=models.ManyToManyField(hotel_fee,blank=True)
    mess_bill_paid=models.ManyToManyField(mess_deposit,blank=True)
    fine_customer=models.ManyToManyField(fine,blank=True)
